...
import com.tanhao.travelbook.bean.HotelReservation;
...
public class HotelService extends BaseService<Hotel>{
    ...
    public List getHotelByParam(String cityName, String date) throws Exception{
        ...
        for(Hotel hotel : list){
            //获取该航班还剩下多少个座位
            Example example2 = new Example(HotelReservation.class);
            Example.Criteria criteria2 = example2.createCriteria();
            criteria2.andEqualTo("resDate",date1);
            criteria2.andEqualTo("hotelName",hotel.getHotelName());
            int count =  reservationService.hotelReservationMapper.selectCountByExample(example2);
